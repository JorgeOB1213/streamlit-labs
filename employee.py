...
fig_hours_gender=px.bar(avg_hours_gender,
                        ...
                        labels=dict(average_work_hours="Total Worked Hours", 
gender="Gender"),
...
st.markdown("Within this site you are able to filter by gender, performance score,  marital status to make a more profund\ analysis. In general we see that the female population in the company work more hours than men. The employees in the company\ are between 30-60 years but the salary is given according to the position they have. We can also appreciate that most of the\ employees have a performance score of 3 and that the worked hours doesnt influence that score.")